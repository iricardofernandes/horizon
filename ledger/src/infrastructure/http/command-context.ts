...
import { actorOf, type LedgerRequest, tenantOf } from './authorization'
...
export function context(request: LedgerRequest): CommandContext {
...
export function idempotent(request: LedgerRequest): IdempotentContext {
