  ...
  return Tenant.create(
    {
      ...
      fiscalProfileEffectiveFrom: row.fiscalProfileEffectiveFrom,
...
function mapCompanyProfile(row: typeof tenants.$inferSelect): CompanyProfile | null {
  ...
  return restored(
    CompanyProfile.create({
      ...
      addressMunicipalityCode: row.addressMunicipalityCode,
...
export function tenantRow(tenant: Tenant): typeof tenants.$inferInsert {
  ...
  return {
    ...
    addressMunicipalityCode: company?.address.municipalityCode ?? null,
