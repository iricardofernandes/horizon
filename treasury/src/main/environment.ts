...
const environmentSchema = z.object({
  PORT: positive.max(65_535).default(3008),
...
export type TreasuryEnvironment = z.infer<typeof environmentSchema>
...
export function readEnvironment(
  ...
  if (!parsed.success) {
    ...
    throw new Error(`Invalid treasury configuration: ${fields.join(', ')}`)
  }
  return parsed.data
}
