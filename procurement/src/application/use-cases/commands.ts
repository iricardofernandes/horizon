...
import type { AuditRecord, ProcurementScope, ProcurementUnitOfWork } from '../ports/unit-of-work'
...
export function once<T>(
  unitOfWork: ProcurementUnitOfWork,
  context: IdempotentContext,
  command: string,
  request: unknown,
  work: (scope: ProcurementScope) => Outcome<T>,
): Outcome<T> {
